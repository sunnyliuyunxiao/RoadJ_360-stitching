#ifndef LEFTCAMERAWINDOWS_H
#define LEFTCAMERAWINDOWS_H
...
class LeftCameraWindows : public QWidget
{
    Q_OBJECT


public:
    LeftCameraWindows(QWidget *parent = Q_NULLPTR, Qt::WindowFlags f = Qt::WindowFlags());
    ~LeftCameraWindows();
