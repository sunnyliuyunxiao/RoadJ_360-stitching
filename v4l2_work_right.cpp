...
//////////////////////////////////////////////////////
CameraWorkRight::CameraWorkRight(QObject *parent)
{
...
//获取一帧数据
//////////////////////////////////////////////////////
int CameraWorkRight::read_frame(CameraStruct *camera)
{

}

int CameraWorkRight::v4l_capture_setup(CameraStruct *camera)
{
...
int CameraWorkRight::start_capturing(CameraStruct *camera)
{
        unsigned int i;
...
//            memcpy(((uchar*)(g_g2d_src_buffer[offsetCount]->buf_vaddr) + (theCamera * 2 *width *height)),((camera->buf)[capture_buf.index])->start, ((camera->buf)[capture_buf.index])->length);
            ...
            emit whichRightFrame(offsetCount);
            offsetCount++;
...
void CameraWorkRight::setCameraName(CameraStruct *camera,QString name)
{
...
void CameraWorkRight::setCameraName(QString name)
{
    this->cameraName = name;
    memcpy(&camera.dev_name,cameraName.toLatin1().data(),sizeof(camera.dev_name));
}

unsigned char * CameraWorkRight::setCameraData(unsigned char **data)
{
...
CameraWorkRight::~CameraWorkRight()
{
