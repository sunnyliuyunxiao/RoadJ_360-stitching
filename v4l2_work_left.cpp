...
//////////////////////////////////////////////////////
CameraWorkLeft::CameraWorkLeft(QObject *parent)
{
...
//获取一帧数据
//////////////////////////////////////////////////////
int CameraWorkLeft::read_frame(CameraStruct *camera)
{

}

int CameraWorkLeft::v4l_capture_setup(CameraStruct *camera)
{
...
int CameraWorkLeft::start_capturing(CameraStruct *camera)
{
        unsigned int i;
...
//            memcpy(((uchar*)(g_g2d_src_buffer[offsetCount]->buf_vaddr) + (theCamera * 2 *width *height)),((camera->buf)[capture_buf.index])->start, ((camera->buf)[capture_buf.index])->length);
            ...
            emit whichLeftFrame(offsetCount);
            offsetCount++;
...
void CameraWorkLeft::setCameraName(CameraStruct *camera,QString name)
{
...
void CameraWorkLeft::setCameraName(QString name)
{
    this->cameraName = name;
    memcpy(&camera.dev_name,cameraName.toLatin1().data(),sizeof(camera.dev_name));
}

unsigned char * CameraWorkLeft::setCameraData(unsigned char **data)
{
