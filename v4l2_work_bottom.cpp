...
//////////////////////////////////////////////////////
CameraWorkBottom::CameraWorkBottom(QObject *parent)
{
...
//获取一帧数据
//////////////////////////////////////////////////////
int CameraWorkBottom::read_frame(CameraStruct *camera)
{

}

int CameraWorkBottom::v4l_capture_setup(CameraStruct *camera)
{
...
int CameraWorkBottom::start_capturing(CameraStruct *camera)
{
        unsigned int i;
...
//            memcpy(((uchar*)(g_g2d_src_buffer[offsetCount]->buf_vaddr) + (theCamera * 2 *width *height)),((camera->buf)[capture_buf.index])->start, ((camera->buf)[capture_buf.index])->length);
            ...
            emit whichBottomFrame(offsetCount);
            offsetCount++;
...
void CameraWorkBottom::setCameraName(CameraStruct *camera,QString name)
{
...
void CameraWorkBottom::setCameraName(QString name)
{
    this->cameraName = name;
    memcpy(&camera.dev_name,cameraName.toLatin1().data(),sizeof(camera.dev_name));
}

unsigned char * CameraWorkBottom::setCameraData(unsigned char **data)
{
...
CameraWorkBottom::~CameraWorkBottom()
{
