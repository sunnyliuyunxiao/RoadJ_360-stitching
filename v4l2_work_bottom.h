#ifndef V4L2_WORK_BOTTOM_H
#define V4L2_WORK_BOTTOM_H

#include <QThread>
#include <QString>
#include <linux/videodev2.h>

class CameraWorkBottom : public QThread
{
...
public:
    CameraWorkBottom(QObject *parent = Q_NULLPTR);
    ~CameraWorkBottom();
